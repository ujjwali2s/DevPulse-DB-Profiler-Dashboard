...
// //   const handleSearch = () => {
// //     if (!genreTerm.trim()) {
// //       setMessage('Please enter a genre to search.');
// //       setBooks([]);
// //       return;
// //     }
...
// //     fetch(`http://localhost:5000/search/search-books?genre=${encodeURIComponent(genreTerm)}`)
// //       .then((res) => {
...
// //       <h1 className="gothic-header">Search Books by Genre</h1>
...
//     fetch(`http://localhost:5000/search/search-books?genre=${encodeURIComponent(searchTerm)}`)
//       .then(res => {
//         if (!res.ok) throw new Error('Failed to fetch');
//         return res.json();
//       })
